namespace FanFiction.Tests.FanFictionServices.ChapterService
{
    using System;
    using System.Linq;
    ...
    {
        private UserManager<FanFictionUser> userManager => this.Provider.GetRequiredService<UserManager<FanFictionUser>>();
        ...
        {
            //arrange
            var moderator = new FanFictionUser
            {
                Id = "adminUser",
                Nickname = "ThirdUser",
                UserName = "AdminUser",

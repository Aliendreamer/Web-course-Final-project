namespace FanFiction.Tests.FanFictionServices.MessageService
{
    using Base;
    using Models;
    using System;
    ...
    public class MessageServiceTests : BaseServiceFake
    {
        ...
        private UserManager<FanFictionUser> userManager => (UserManager<FanFictionUser>)this.Provider.GetService(typeof(UserManager<FanFictionUser>));

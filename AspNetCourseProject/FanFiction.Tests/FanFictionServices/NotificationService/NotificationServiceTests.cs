namespace FanFiction.Tests.FanFictionServices.NotificationService
{
    using System;
    using System.Linq;
    using Base;
    ...
    public class NotificationServiceTests : BaseServiceFake
    {
        ...
        private UserManager<FanFictionUser> userManager =>
            (UserManager<FanFictionUser>)this.Provider.GetService(typeof(UserManager<FanFictionUser>));
